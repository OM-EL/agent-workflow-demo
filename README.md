...
| `io.github.ChromeDevTools/chrome-devtools-mcp` | Chrome DevTools protocol for browser debugging |
| `oraios/serena` | IDE assistant with code intelligence |
| `io.github.netdata/mcp-server` | Infrastructure and server monitoring via Netdata Cloud |
